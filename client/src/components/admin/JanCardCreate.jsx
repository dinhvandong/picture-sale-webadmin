...
import { createJanCard } from '../../services/api_janCard';
...
const JanCardCreate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const updatedFormData = {
            ...formData,
            janItemBenefits: items, // Update the specific field
        };
        ...
        console.log("janItemBenefits::", jsonData);
        const result = await createJanCard(jsonData);
    ...
    return (
        <div className='flex flex-col w-full h-auto'>
            ...
            <div className="flex justify-start mt-5 ml-5 md:justify-center sm:justify-center lg:justify-start">
                <p className="font-bold">Tạo mới thẻ</p>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="w-full mx-auto mt-2 ml-5 mr-5">
                        ...
                        <div className="mb-2">
                            <label htmlFor="email" className="block mb-2 font-medium">
                                Tài khoản (Email): <span className="text-lg text-red-500">*</span>
                            </label>
                            <input
                                type="email"
                                id="email"
