...
const CruiseList = () => {
    ...
    const handleInsert = () => {
        navigate("/admin/cruise/create-new");
    };
    const handleSearch = () => {
    ...
    return (
        <div className='flex flex-col w-full h-auto'>
            ...
            <div className="flex justify-start mt-5 md:justify-center sm:justify-center lg:justify-start">
                <p className="ml-5 font-bold">Cruise List</p>
            </div>
            <Button className="w-[160px] ml-5  mt-5 font-bold text-center mb-5 bg-base_color" type="primary" onClick={handleInsert}>
                New Cruise
            </Button>
