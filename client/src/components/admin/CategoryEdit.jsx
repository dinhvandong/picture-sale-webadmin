...
const CategoryEdit = (props) => {
    ...
    return (
        <div className='w-full h-auto flex flex-col bg-[#EEA048]'>
            ...
            <div className='flex items-center gap-3 my-5'>
                ...
                <button className='flex items-center justify-center w-24 p-4 text-white rounded h-9 bg-insert hover:shadow-lg'>Tạo mới</button>
            </div>
